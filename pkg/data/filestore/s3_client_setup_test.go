...
var s3UploaderTest *s3manager.Uploader
var s3DownloaderTest *s3manager.Downloader
...
func TestMain(m *testing.M) {
	...
	s3UploaderTest = s3manager.NewUploader(sess)
	s3DownloaderTest = s3manager.NewDownloader(sess)
